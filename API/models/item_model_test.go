...
var itemTest = []Item{
	{1, "Samantha", time.Now(), "Memoria USB 1TB", 2, 150, " ", 0.0},
	{2, "Pedro", time.Now(), "Vino La Rosa", 3, 200, " ", 0.0},
	{3, "Selim", time.Now(), "Caja plástica", 1, 55, " ", 0.0},
	{4, "Gloria", time.Now(), "Cepillo dental", 3, 70, " ", 0.0},
	{5, "Alejandra", time.Now(), "Mouse", 3, 45, " ", 0.0},
	{6, "Gloria", time.Now(), "Galleta", 2, 50, " ", 0.0},
}
